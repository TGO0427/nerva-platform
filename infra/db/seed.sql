...
-- 37 Sales Orders (5 current + 32 historical across 12 months)
-- 24 Purchase Orders (5 current + 19 historical across 12 months)
...
-- 2 RMAs (K58 site)
-- 2 GRNs (K58 site)
-- 14 Supplier NCRs (decreasing trend over 12 months)
