...
import { useWarehouseCapacity } from '@/lib/queries';
...
export default function WarehouseCapacityPage() {
  ...
  const { data: warehouses, isLoading } = useWarehouseCapacity();
  ...
  const columns: Column<WarehouseCapacity>[] = [
    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <p className="text-text-muted dark:text-text-dark-muted mt-1">
          Current pallet-position utilization across your warehouses.
        </p>
      </div>
