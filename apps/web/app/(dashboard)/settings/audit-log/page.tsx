        ...
        <table className="w-full text-xs">
          <thead>
            <tr className="border-b">
              ...
              <th className="text-left py-1 pr-4 font-medium text-gray-600">Before</th>
              <th className="text-left py-1 font-medium text-gray-600">After</th>
            </tr>
          </thead>
          <tbody>
            {changes.map((c) => (
              <tr key={c.key} className="border-b border-gray-100">
                <td className="py-1 pr-4 font-medium text-gray-700">{c.key}</td>
                    ...
                    <Fragment key={entry.id}>
                      ...
                      >
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm">
                          {entry.actorName || <span className="text-gray-400">System</span>}
                        </td>
