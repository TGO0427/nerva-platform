...
export class IntegrationsService {
  ...
  async updateConnectionStatus(
    ...
    const connection = await this.repository.updateConnectionStatus(
      id,
      status,
      errorMessage,
    );
  ...
  async updateConnectionConfig(
    ...
    const connection = await this.repository.updateConnectionConfig(
      id,
      configJson,
    );
    if (!connection)
  ...
  async connect(
    ...
    return this.repository.updateConnectionStatus(
      id,
      "CONNECTED",
