...
export class PortalController {
  ...
  async listOrders(
    ...
    return this.portalService.getOrders(
      user.tenantId,
      this.getCustomerId(user, req),
      page,
      limit,
  ...
  async getOrder(
    ...
    return this.portalService.getOrder(
      user.tenantId,
      this.getCustomerId(user, req),
      id,
    );
  ...
  async getInvoice(
    ...
    return this.portalService.getInvoice(
      user.tenantId,
      this.getCustomerId(user, req),
      id,
    );
  ...
  async downloadInvoice(
    ...
    // Verify ownership
    await this.portalService.getInvoice(
      user.tenantId,
      this.getCustomerId(user, req),
      id,
    );
  ...
  async listDeliveries(
    ...
    return this.portalService.getDeliveries(
      user.tenantId,
      this.getCustomerId(user, req),
      page,
      limit,
  ...
  async getDelivery(
    ...
    return this.portalService.getDelivery(
      user.tenantId,
      this.getCustomerId(user, req),
      stopId,
    );
  ...
  async getPod(
    ...
    return this.portalService.getPod(
      user.tenantId,
      this.getCustomerId(user, req),
      stopId,
    );
  ...
  async downloadPodDoc(
    ...
    return this.portalService.getPodDocumentUrl(
      user.tenantId,
      this.getCustomerId(user, req),
      stopId,
      docId,
  ...
  async listReturns(
    ...
    return this.portalService.getReturns(
      user.tenantId,
      this.getCustomerId(user, req),
      page,
      limit,
  ...
  async getReturn(
    ...
    return this.portalService.getReturn(
      user.tenantId,
      this.getCustomerId(user, req),
      id,
    );
